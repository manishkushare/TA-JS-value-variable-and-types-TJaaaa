...
let userProfession = prompt("Enter the profession of the user");
let isAdult = confirm("Is user is adult?");
...
*/
let numA = prompt("Enter a value A");
let numB = prompt("Enter a value B");
alert(`${numA + numB}`);
alert(`${numA - numB}`);
alert(`${numA * numB}`);
